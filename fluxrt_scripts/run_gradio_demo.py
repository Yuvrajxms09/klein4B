...
def get_processor():
    ...
    if stream_processor is None:
        # stream_processor = StreamProcessor("fluxrt_configs/stream_processor_config.json") # uncomment if you dont need reference image
        stream_processor = StreamProcessor("fluxrt_configs/config_with_reference.json")
